...
class AdapterFranquicias(
    val viewModel: MainActivityViewModel,
    var arrayList: ArrayList<ModelFranquicias?>?,
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is MainViewHolder) {
            val model: ModelFranquicias = arrayList?.get(position)!!
            holder.itemView.title.text = model.negocio
    ...
    interface OnClickListener {
        fun onClick(modelData: ModelFranquicias)
    }
    ...
    fun setList(arrayList: ArrayList<ModelFranquicias?>?) {
