...
import com.example.prac.model.ModelFilteredDataInfo
...
class AdapterData(
    ...
    var arrayList: ArrayList<ModelFilteredDataInfo?>?,
...
//        d("mytag", "VIEWTYPE::::::$viewType")
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is MainViewHolder) {
            val model: ModelFilteredDataInfo = arrayList?.get(position)!!
            holder.itemView.title.text = model.nombre

            holder.itemView.rvCategories.layoutManager = LinearLayoutManager(context)
            holder.itemView.rvCategories.adapter =
                AdapterCategory(model.categoria, holder.itemView.rvCategories)
    ...
    interface OnClickListener {
        fun onClick(ModelFilteredDataInfo: ModelFilteredDataInfo)
    }
    ...
    fun setList(arrayList: ArrayList<ModelFilteredDataInfo?>?) {
